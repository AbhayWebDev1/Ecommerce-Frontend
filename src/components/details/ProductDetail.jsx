          ...
          <Table>
             <TableBody>
                 ...
                 <ColumnText>
                     ...
                     <TableCell>1 Year Domestic Warranty</TableCell>
                 </ColumnText>
                 <ColumnText>
                     ...
                     <TableCell >
                        ...
                        <Typography>View more Seller strating from ₹{product.price.cost} </Typography>
                     </TableCell>
                 </ColumnText>
                 <ColumnText>
                     <TableCell colSpan={2}>
                        <img src={adURL} style={{ width: 390 }} alt="flipkartpoi" />
                     </TableCell>
                 </ColumnText>
                 <ColumnText>
